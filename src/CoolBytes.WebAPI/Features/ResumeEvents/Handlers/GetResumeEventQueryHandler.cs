...
{
    public class GetResumeEventQueryHandler : IAsyncRequestHandler<GetResumeEventQuery, ResumeEventViewModel>
    {
        ...
        public async Task<ResumeEventViewModel> Handle(GetResumeEventQuery message)
        {
