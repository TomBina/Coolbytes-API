...
namespace CoolBytes.Data.Migrations
{
    ...
    [Migration("20190814080609_AddedIsCourseToCategory")]
    partial class AddedIsCourseToCategory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoolBytes.Core.Domain.MetaTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CoolBytes.Core.Domain.MetaTag", b =>
                {
                    b.HasOne("CoolBytes.Core.Domain.BlogPost")
                        .WithMany("MetaTags")
                        .HasForeignKey("BlogPostId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
